        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#" class="btn btn-info mt-auto">Go to General Settings</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#" class="btn btn-warning mt-auto">Go to Security Settings</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#" class="btn btn-primary mt-auto">View User Activity Log</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#" class="btn btn-success mt-auto">Go to Notification Preferences</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#" class="btn btn-danger mt-auto">Go to Visitor Settings</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#" class="btn btn-secondary mt-auto">Go to Employee Access Settings</a>
                </div>
            </div>
        </div>
    </div>
